...
class Lang
{
    ...
    public function __construct(string $lang, string $basePart = null)
    {
        ...
        if(!is_null($basePart))
        {
            $this->files['default'] = ["file" => new IniFile(dirname(dirname(__DIR__)).DIRECTORY_SEPARATOR.APPLICATION_PATH.DIRECTORY_SEPARATOR.$basePart.DIRECTORY_SEPARATOR.'Langs'.DIRECTORY_SEPARATOR.$lang.DIRECTORY_SEPARATOR.'default.ini';, "use" => true];
        }
    }
    ...
    public function addFile(string $fileName, string $part = null)
    {
        ...
        {
            $filePath = dirname(dirname(__DIR__)).DIRECTORY_SEPARATOR.APPLICATION_PATH.DIRECTORY_SEPARATOR.((isset($part)) ? $part.DIRECTORY_SEPARATOR : (isset($this->basePart) ? $this->basePart.DIRECTORY_SEPARATOR : '' )).'Langs'.DIRECTORY_SEPARATOR.$lang.DIRECTORY_SEPARATOR.'default.ini';;
